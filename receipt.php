		...
		<div class="contact-main">
			...
			<div class="panel panel-primary" id="panel-0">
			    ...
			    <div class="panel-body" id="panel-body">
			     <p><h3 style="border-bottom:1px solid teal;">Instructions</h3>
			     	<hr />
			      <P>*Please keep the application token for verification purpose.The purpose of this token is to validate the application receipt when processing the enrolment data</p>
			     </p>
			      <?php 
			      	echo "Application Token: ",$_SESSION['applicationToken'];
			      ?>
			    </div>
 		   </div>
